...
# 配置参数
INPUT_DIR = "E:/DREAMT base/DREAMT-main/data_100Hz"
OUTPUT_DIR = "E:/DREAMT base/DREAMT-main/data_100Hz_processed"
REQUIRED_COLS = [  # 修改后的保留字段（移除ACC三轴数据）
    'TIMESTAMP',
    'TEMP',
    'HR',
    'SAO2',
...
def process_sleep_stage_all(df):
    """处理睡眠阶段标签"""
    allowed_stages = ['W', 'N1', 'N2', 'N3', 'R']
    df = df[df['Sleep_Stage'].isin(allowed_stages)]
    return df
...
print(f"处理后文件示例: {os.listdir(OUTPUT_DIR)[:3]}")